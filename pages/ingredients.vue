...
<template>
  <div class="flex gap-4 max-md:flex-col max-md:items-start lg:items-center lg:justify-between">
  ...
  <div v-if="data" class="mt-6">
    <ul role="list" class="divide-y divide-gray-100">
      <li v-for="ingredient in data.ingredients" class="grid grid-cols-5 gap-2 py-5 md:gap-6">
